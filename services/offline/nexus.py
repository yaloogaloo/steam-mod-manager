"""Nexus Mods offline provider — real webpage snapshot (not local generator)."""
...
class NexusOfflineProvider(OfflineProvider):
    """Snapshot ``source_url`` into ``.info/offline/``."""
    ...
    def get_provider_name(self) -> str:
        return PROVIDER_NEXUS_SNAPSHOT
    ...
    def update_offline_page(
        ...
        *,
        ...
        if not source_url:
            ...
            raise ValueError(f"Nexus Mod has no source_url: mod_id={mid}")
